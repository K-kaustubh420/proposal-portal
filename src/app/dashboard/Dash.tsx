                        ...
                        <div className="bg-blue-50 rounded-lg border-t-4 border-blue-800 shadow-md shadow-blue-950 p-8 max-w-md w-full">
                            ...
                            <div className="mt-6 flex justify-end space-x-2">
                                {selectedProposal.status !== 'Approved' && (
                                    <>
                                        <button className="btn btn-info font-bold text-white" onClick={() => updateProposalStatus(selectedProposal, 'Review')}>Review</button>
                                        <button
                                            onClick={() => updateProposalStatus(selectedProposal, 'Rejected')}
                                        ...
                                        <button
                                            onClick={() => updateProposalStatus(selectedProposal, 'Approved')}
...
>>>>>>> 336fddd2f49ffe0ef944210c604d5c8159442fdb
